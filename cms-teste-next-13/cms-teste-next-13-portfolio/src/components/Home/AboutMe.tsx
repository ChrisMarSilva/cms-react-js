        ...
        <main className="flex flex-wrap-reverse justify-center items-center gap-10 md:gap-32 py-8 text-lg text-center xl:text-left xl:flex-nowrap xl:justify-between">
            <div className="text-white flex flex-col items-center xl:items-start gap-4 w-full xl:w-120">
                <h1 className="text-3xl sm:text-7xl xl:leading-[80px]">
                    Prazer, sou
                    <span className="font-bold"> Chris MarSil</span>
                </h1>
                <div className="mb-12">
            ...
            <div className="relative">
                <Image
                    src="https://avatars.githubusercontent.com/u/29840808?v=4"
                    alt="Foto de Perfil de Huriel. Homem caucasiano, cabelo castanho e um sorriso no rosto"
                    width={500}
                    height={500}
                    unoptimized
                    priority
