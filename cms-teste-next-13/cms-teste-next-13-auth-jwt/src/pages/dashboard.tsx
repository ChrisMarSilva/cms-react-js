...
import getAllCategorias from '@/services/getAllCategorias'
...
export default function Dashboard() {
    ...
    useEffect(() => {
        ...
        const fetchDataCategorias = async () => {
            // api.get('categorias');
            const categoriasData: Promise<Categoria[]> = getAllCategorias()
                                        ...
                                        <div className="ml-10 flex items-baseline space-x-4">
                                            {navigation.map((item, itemIdx) =>
                                                itemIdx === 0 ? (
                                                    ...
                                                    <a key={item} href="#" className="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium" >
                                                        {item}
                                                    </a>
                                                )
                                            )}
                        ...
                        <Disclosure.Panel className="md:hidden">
                            ...
                            <div className="pt-4 pb-3 border-t border-gray-700">
                                ...
                                <div className="mt-3 px-2 space-y-1">
                                    {profile.map((item) => (
                                        <a key={item} href="#" className="block px-3 py-2 rounded-md text-base font-medium text-gray-400 hover:text-white hover:bg-gray-700" >
                                            {item}
                                        </a>
                                    ))}
            ...
            <main>
                <div className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
                    <div className="px-4 py-6 sm:px-0">
                        <h2>Categorias</h2>
                        {categorias?.map(categoria => <p key={categoria.Id}> {categoria.Nome} </p>)}
